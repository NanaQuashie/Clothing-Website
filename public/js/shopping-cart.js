...
// console.log('basket',basket)
 ...
 let calculation =()=>{
  ...
  let generateCartItems = ()=>{
    if(basket.length !==0){
    return (ShoppingCart.innerHTML = basket.map((n)=>{
       
        let { id, item } = n;
        let search = shopItemsData.find((d)=>d.id === id) || [];
        let {img, name, price} = search;
        return `
        <div class="cart-item">
             <img width="100" src=${img} alt="" />
            <div class='details'>
                <div class="title-price-d">
